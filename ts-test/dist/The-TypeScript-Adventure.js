...
// Steg 3: Äventyret
let enemies = ["Slemprop", "  Varg", "Drake"];
let monster = enemies.map(x => enemies[Math.floor(Math.random() * 3)]);
...
let eb = ["Slemprop", "  Varg", "Drake"];
const monsters = ["Slemprop", "  Varg", "Drake"].map(x => eb[Math.floor(Math.random() * 3)]);
...
export {};
//# sourceMappingURL=The-TypeScript-Adventure.js.map