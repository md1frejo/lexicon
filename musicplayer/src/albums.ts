...
const artits:string[]=["william orbit","front 242","metallica","slayer","orbital","kyuss"]
const titles:string[]=["myoracle lives uptown","lovley day","one","war ensemble","in dub","blues for the red sun"]
const ids:number[]=[1,2,3,4,5,6];
const durations:number[]=[12,34,5,678,9,9]

const allarts: [string[], string[], number[]] = [artits, titles, ids]
...
type playstatus = "played" | "paused" | "stop"
